...
export const TypedText: FC<TypedTextProps> = ({textList, typeSpeed, backSpeed, backDelay, loop, cursorChart}) => {
    ...
    return (
        <div className={styles.typedCursor}>
            <h1 style={{display: "inline-block", fontSize: 48}} className={styles.typedCursor} ref={el} />
        </div>
    );
}